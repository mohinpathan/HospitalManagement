...
<div class="pay-card">
    ...
    <div class="bill-summary">
        <div class="bill-row"><span>Doctor</span><span><%=bill.getDoctorName()%></span></div>
        <div class="bill-row"><span>Consultation Fee</span><span>₹<%=String.format("%.0f",bill.getConsultationFee())%></span></div>
        <div class="bill-row"><span>Medicine Charge</span><span>₹<%=String.format("%.0f",bill.getMedicineCharge())%></span></div>
        <div class="bill-row"><span>Other Charges</span><span>₹<%=String.format("%.0f",bill.getOtherCharge())%></span></div>
        <div class="bill-row"><span>Total Amount</span><span style="color:#19b37a">₹<%=String.format("%.2f",bill.getTotalAmount())%></span></div>
    </div>
    ...
    <form action="/HospitalManagement/patient/payment/process" method="post">
        ...
        <!-- Payment Method -->
        <div style="font-weight:700;font-size:14px;color:#0f172a;margin-bottom:12px">Select Payment Method</div>
    ...
    <p style="text-align:center;margin-top:16px;font-size:14px">
        <a href="/HospitalManagement/patient/medicalRecords" style="color:#64748b">← Cancel and go back</a>
    </p>
    <%}%>
</div>
</div>
