...
<div class="dash-main">
    ...
    <div style="background:#fee2e2;color:#991b1b;border:1px solid #fecaca;border-radius:10px;padding:16px;display:flex;align-items:center;gap:10px">
        <i class="fa fa-exclamation-circle"></i> Patient not found. Please go back and try again.
    </div>
    <%} else {
        ...
        long completedCount = appts != null ? appts.stream().filter(a -> "completed".equals(((Appointment)a).getStatus())).count() : 0;
    %>
    ...
    <div class="mini-stats">
        <div class="mini-stat">
            ...
            <div class="ms-label">Total Appointments</div>
        </div>
        <div class="mini-stat">
        ...
        <div class="col-lg-4">
            <div class="profile-card">
                ...
                <div class="info-row">
                    ...
                    <span><%=p.getPhone()!=null?p.getPhone():"—"%></span>
                </div>
                <div class="info-row">
                    <i class="fa fa-venus-mars" style="color:#7c3aed"></i>
                    <span class="info-label">Gender</span>
                    <span><%=p.getGender()!=null?p.getGender():"—"%></span>
                </div>
                <div class="info-row">
                    <i class="fa fa-calendar" style="color:#f59e0b"></i>
                    <span class="info-label">Age</span>
                    <span><%=p.getAge()>0?p.getAge()+" years":"—"%></span>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span style="font-size:13px"><%=p.getAddress()!=null?p.getAddress():"—"%></span>
                </div>
            </div>
        </div>

        <!-- Right: Appointments + Bills -->
        <div class="col-lg-8">
            ...
            <div class="panel">
                ...
                <table class="tbl">
                    <thead><tr><th>Doctor</th><th>Department</th><th>Date</th><th>Time</th><th>Reason</th><th>Status</th></tr></thead>
                    <tbody>
            ...
            <div class="panel">
                <div class="ph">
                    <span><i class="fa fa-file-invoice-dollar me-2" style="color:#f59e0b"></i>Billing History</span>
                ...
                <div style="overflow-x:auto">
                <table class="tbl">
                    <thead><tr><th>Bill #</th><th>Doctor</th><th>Diagnosis</th><th>Total</th><th>Method</th><th>Status</th><th>PDF</th></tr></thead>
                    <tbody>
                    <% for(Object obj:bills){ Bill b=(Bill)obj; %>
                    <tr>
                        <td style="color:#94a3b8;font-size:12px">#<%=b.getId()%></td>
                        <td style="font-weight:600"><%=b.getDoctorName()%></td>
                        <td style="font-size:13px;max-width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap"><%=b.getDiagnosis()!=null?b.getDiagnosis():"—"%></td>
