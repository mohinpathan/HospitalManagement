...
.profile-hero{background:linear-gradient(135deg,#2b7cff,#1a5fd4);border-radius:18px;padding:28px;color:#fff;margin-bottom:24px;display:flex;align-items:center;gap:20px}
...
.form-card .card-title i{color:#2b7cff}
...
<div class="dash-main">
    ...
    <div class="page-hdr">
        <h2><i class="fa fa-user-shield me-2" style="color:#2b7cff"></i>Admin Profile</h2>
