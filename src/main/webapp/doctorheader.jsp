...
.badge-doctor{background:#d1fae5;color:#065f46;font-size:10px;font-weight:700;padding:3px 8px;border-radius:20px}
...
.lang-sw a.on{background:linear-gradient(135deg,#19b37a,#0d9668);color:#fff}
...
<div class="role-nav">
    ...
    <div class="nav-right">
        <a href="/HospitalManagement/doctor/dashboard"><i class="fa fa-th-large me-1"></i><%=t(hi,"Dashboard","डैशबोर्ड")%></a>
        <a href="/HospitalManagement/doctorabout.jsp"><%=t(hi,"About","हमारे बारे में")%></a>
        <a href="/HospitalManagement/doctorcontact.jsp"><%=t(hi,"Contact","संपर्क")%></a>
        <div class="user-chip">
            <i class="fa fa-user-md" style="color:#19b37a"></i>
            <%= session.getAttribute("doctorName") != null ? session.getAttribute("doctorName") : "Doctor" %>
            <span class="badge-doctor"><%=t(hi,"डॉक्टर","DOCTOR")%></span>
        </div>
