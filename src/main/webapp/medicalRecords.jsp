...
.record-card-header{padding:16px 22px;border-bottom:1px solid #f1f5f9;display:flex;justify-content:space-between;align-items:center;background:#fafbff}
.record-card-header .doc-info{display:flex;align-items:center;gap:12px}
.record-card-header .doc-avatar{width:42px;height:42px;border-radius:10px;background:linear-gradient(135deg,#ede9fe,#ddd6fe);display:flex;align-items:center;justify-content:center;font-size:18px;color:#7c3aed}
.record-card-header .doc-name{font-weight:700;font-size:15px;color:#0f172a}
.record-card-header .doc-date{font-size:12px;color:#64748b;margin-top:2px}
.record-card-body{padding:22px}
...
.bill-item{background:#f8fafc;border-radius:10px;padding:12px 16px;flex:1;min-width:120px;text-align:center}
...
.b-label{font-size:11px;color:#64748b;font-weight:600;margin-bottom:4px}
.b-value{font-size:16px;font-weight:800;color:#0f172a}
...
.empty-state h4{font-size:20px;font-weight:700;color:#374151;margin-bottom:8px}
.btn-pay-online{background:linear-gradient(135deg,#19b37a,#0d9668);color:#fff;border:none;border-radius:10px;padding:9px 18px;font-size:13px;font-weight:600;cursor:pointer;text-decoration:none;display:inline-flex;align-items:center;gap:6px;transition:all .2s}
.btn-pay-online:hover{opacity:.9;color:#fff;transform:translateY(-1px)}
.btn-pdf{background:#eff6ff;color:#2b7cff;border:1px solid #bfdbfe;border-radius:10px;padding:9px 16px;font-size:13px;font-weight:600;text-decoration:none;display:inline-flex;align-items:center;gap:6px;transition:all .2s}
.btn-pdf:hover{background:#dbeafe;color:#1e40af}
...
<div class="dash-main">
    ...
    <div class="page-hdr">
        ...
        <p>Your complete prescription and payment history.</p>
    </div>
    ...
    <div class="record-card">
        <div class="record-card-header">
            ...
            <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
                ...
                <a href="/HospitalManagement/patient/bill/pdf/<%=b.getId()%>" target="_blank" class="btn-pdf"><i class="fa fa-file-pdf"></i> PDF</a>
                <% if("pending".equals(b.getPaymentStatus())){ %>
                <a href="/HospitalManagement/patient/payment/<%=b.getId()%>" class="btn-pay-online"><i class="fa fa-credit-card"></i> Pay Online</a>
                <% } %>
            </div>
        </div>
