...
<%
    ...
    // Read remember-me cookies to pre-fill form
    String savedEmail = "";
    String savedRole  = "";
...
.ig-eye{background:#f1f5f9;border:1.5px solid #e5e7eb;border-left:none;border-radius:0 10px 10px 0;padding:0 14px;display:flex;align-items:center;color:#64748b;cursor:pointer;transition:background .2s}
...
<div class="login-card">
    ...
    <div class="alert-msg alert-danger"><i class="fa fa-exclamation-circle"></i> Invalid email or password.</div>
    <% } %>

    <% if(hasCookie){ %>
    <div class="cookie-banner">
        <i class="fa fa-cookie-bite"></i>
        Welcome back! Your email has been pre-filled from your saved session.
    </div>
    <% } %>
    ...
    <form action="/HospitalManagement/login" method="post">
        ...
        <div style="margin-bottom:16px">
            ...
            <select name="role" class="form-select" required>
                ...
                <option value="patient"  <%="patient".equals(savedRole) ?"selected":""%>>🧑 Patient</option>
                <option value="doctor"   <%="doctor".equals(savedRole)  ?"selected":""%>>👨‍⚕️ Doctor</option>
                <option value="admin"    <%="admin".equals(savedRole)   ?"selected":""%>>🛡️ Admin</option>
            </select>
        </div>
        ...
        <div style="margin-bottom:12px">
            ...
            <div class="input-group">
                ...
                <span class="ig-eye" onclick="togglePass()">
    ...
    <p style="text-align:center;margin-top:20px;font-size:14px;color:#64748b">
        ...
        <a href="/HospitalManagement/register.jsp" style="color:#2b7cff;font-weight:600">Register here</a>
    </p>
</div>
</div>
